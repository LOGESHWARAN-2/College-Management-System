...
public class Employee {
	...
	public void create(Database database) {
		try {
			...
			String insert = "INSERT INTO `employees`(`ID`,`FirstName`,`LastName`,`Email`,`PhoneNumber`,`BirthDate`,`Salary`,`Department`,`password`)"
					+ "  VALUES('"+ID+"','"+firstName+"','"+lastName+"','"+email+"','"+phoneNumber+"','"+birthDate+"','"+salary+"','"+department.getID()+"','"+password+"');" ;
	...
	private Operation[] manageOperations =new Operation[] {
	...
	public void showList(Database database,Scanner scanner) {
		if(department.getName().equals("Management")) {
			...
			System.out.print("Welcome to University Management System");
			...
			manageOperations[selected-1].oper(database, scanner,getID());
